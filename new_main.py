...
def get_args():
    ...
    parser.add_argument('--epochs', default=30, type=int, help="num epochs")
    parser.add_argument('--lambda_val', default=0.6, type=float, help="loss weight for coral")
    parser.add_argument('--deco_lambda', default=1e-3, type=float, help="loss weight for deco image norm")
    parser.add_argument('--fc7_lambda', default=1e3, type=float, help="loss weight for coral on fc7")
    ...
    parser.add_argument('--source', default="amazon", help="source domain")
    parser.add_argument('--target', default="webcam", help="target domain")
