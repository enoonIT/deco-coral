...
def get_args():
    ...
    parser.add_argument('--lambda_val', default=0.6, type=float, help="")
    parser.add_argument('--deco_lambda', default=1e-3, type=float, help="loss weight for deco image norm")
    parser.add_argument('--fc7_lambda', default=1e3, type=float, help="")
    ...
    parser.add_argument('--source', default="amazon", help="")
    parser.add_argument('--target', default="webcam", help="")
